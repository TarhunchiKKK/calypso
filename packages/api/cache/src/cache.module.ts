...
import { CACHE_OPTIONS_INJECTION_TOKEN, type CacheModuleAsyncOptions, type CacheModuleOptions, type CacheOptionsFactory } from "./config/di.lib";
        ...
        return [
            {
                ...
                useFactory: async (factory: CacheOptionsFactory) => {
                    return await factory.createCacheOptions();
                }
            },
            {
